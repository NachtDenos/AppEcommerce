                ...
                <div class="modal-body">
                    <div class="contenido-form">
                      ...
                      <h4>Filtro:</h4>
                        ...
                        <input type="text" id="precioModal" name="precioModal">
                        
                    </div>
                </div>
                <div class="modal-footer">
                  <input class="btn btn-modal" type="button" value="Buscar">
                </div>
          </form>
        </div>
      </div>
        ...
        <div class="modal-content fondo-modal">
          <form>
              <div class="modal-header">
                ...
                <div class="modal-footer">
                  <a><input class="btn btn-modal" type="submit" onClick="kevin()" value="Buscar"> </a>
                </div>
          </form>
        </div>
      </div>
